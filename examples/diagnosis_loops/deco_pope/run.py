...
examples/diagnosis_loops/qwen_loop_agy/run.py:
...
# ---------------------------------------------------------------------------
# 3. Loop wiring (mirrors examples/diagnosis_loops/qwen_loop_agy/run.py)
# ---------------------------------------------------------------------------
...
def main() -> None:
    ...
    # parallel probe. Mirrors examples/diagnosis_loops/qwen_loop_claude (--device cuda).
