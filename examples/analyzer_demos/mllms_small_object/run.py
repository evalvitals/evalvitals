...
Usage (direct):
    python examples/analyzer_demos/mllms_small_object/run.py
    python examples/analyzer_demos/mllms_small_object/run.py --max-data-cases 32
    python examples/analyzer_demos/mllms_small_object/run.py --textvqa-size-split all
